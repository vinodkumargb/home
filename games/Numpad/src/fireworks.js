//https://codepen.io/jackrugile/pen/acAgx?editors=1111
var Fireworks = function(){
	...
	self.init = function(){	
		...
		self.canvas = cv;//document.createElement('canvas');				
		////self.canvasContainer = $('#canvas-container');
		
		var canvasContainerDisabled = cv;//document.getElementById('canvas-container');
		self.canvas.onselectstart = function() {
			return false;
		};
		
		self.canvas.width = self.cw = $(canvas).width();
		self.canvas.height = self.ch = $(canvas).height();	
...
function result(self){
	self.ctx.globalCompositeOperation = 'screen';
	self.ctx.font = "30px Arial";// Comic Sans MS";
	self.ctx.fillStyle = "red";
	self.ctx.textAlign = "center";
	self.ctx.fillText("Congratulations! You WON!", self.cw/2, 100); 
	self.ctx.font = "20px Arial";// Comic Sans MS";
	self.ctx.fillStyle = "purple";
	self.ctx.fillText("R e p l a y", 300, 175); 
	self.ctx.globalCompositeOperation = 'destination-atop';
}

function setPreset(obj,val){
	switch(val){
		case "Anti Gravity": 
			obj["fworkSpeed"]= 4;
			obj["fworkAccel"]= 10;
			obj["showShockwave"]= true;
			obj["showTarget"]= false;
			obj["partCount"]= 150;
			obj["partSpeed"]= 5;
			obj["partSpeedVariance"]= 10;
			obj["partWind"]= 10;
			obj["partFriction"]= 10;
			obj["partGravity"]= -10;
			obj["flickerDensity"]= 30;
			obj["hueMin"]= 0;
			obj["hueMax"]= 360;
			obj["hueVariance"]= 30;
			obj["lineWidth"]= 1;
		...
		case "Battle Field": 
			...
			obj["partCount"]= 200;
			obj["partSpeed"]= 30;
			obj["partSpeedVariance"]= 5;
			obj["partWind"]= 0;
			obj["partFriction"]= 5;
			obj["partGravity"]= 0;
			obj["flickerDensity"]= 0;
			obj["hueMin"]= 20;
			obj["hueMax"]= 30;
			obj["hueVariance"]= 10;
			obj["lineWidth"]= 1;
		...
		case "Slow Launch":
			...
			obj["partCount"]= 200;
			obj["partSpeed"]= 10;
			obj["partSpeedVariance"]= 0;
			obj["partWind"]= 100;
			obj["partFriction"]= 0;
			obj["partGravity"]= 2;
			obj["flickerDensity"]= 50;
			obj["hueMin"]= 0;
			obj["hueMax"]= 360;
			obj["hueVariance"]= 20;
			obj["lineWidth"]= 4;
